...
public class BookPersistenceRepositoryAdapter implements BookRepository {
    ...
    public BookPersistenceRepositoryAdapter(final JpaBookRepository jpaBookRepository,
            final BookEntityMapper bookEntityMapper) {
    ...
    public Optional<Book> findBySourceReference(final String sourceReference) {
        return jpaBookRepository.findBySourceReference(sourceReference)
