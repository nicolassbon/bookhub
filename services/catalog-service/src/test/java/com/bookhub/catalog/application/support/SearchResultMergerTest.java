...
class SearchResultMergerTest {
    ...
    void shouldMergeWithoutCrashingWhenExternalItemHasNullTitle() {
        final BookSearchItem nullTitleItem = new BookSearchItem(
                "ext:ol:OL123W", null, "Unknown", "OL123W", null, null, null);

        final List<BookSearchItem> result = new SearchResultMerger().merge(
                List.of(),
                List.of(nullTitleItem));
    ...
    void shouldMergeWithoutCrashingWhenExternalItemHasAllNullIdentifiers() {
        final BookSearchItem nullBothItem = new BookSearchItem(
                null, null, "Unknown", null, null, null, null);

        final List<BookSearchItem> result = new SearchResultMerger().merge(
                List.of(),
                List.of(nullBothItem));
    ...
    void shouldMergeWithoutCrashingWhenExternalItemHasNullSourceReference() {
        final BookSearchItem nullRefItem = new BookSearchItem(
                null, "Some Title", "Author", null, null, null, null);
