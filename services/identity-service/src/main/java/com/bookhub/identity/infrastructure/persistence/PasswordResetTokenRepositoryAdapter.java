...
public class PasswordResetTokenRepositoryAdapter implements PasswordResetTokenRepository {
  ...
  public PasswordResetTokenRepositoryAdapter(
      final PasswordResetTokenJpaRepository passwordResetTokenJpaRepository) {
  ...
  public Optional<UUID> consumeUserIdByTokenHash(final String tokenHash, final Instant now) {
    final List<UUID> consumedUserIds =
        passwordResetTokenJpaRepository.consumeUserIdByTokenHash(tokenHash, now);
