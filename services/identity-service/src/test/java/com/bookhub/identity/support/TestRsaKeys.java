...
public final class TestRsaKeys {
    ...
    private static final KeyPair KEY_PAIR_OTHER_2048 = generateKeyPair(2048);
    private static final KeyPair KEY_PAIR_1024 = generateKeyPair(1024);
    ...
    public static final String PRIVATE_1024 = toPrivatePem(KEY_PAIR_1024.getPrivate());
    public static final String PUBLIC_OTHER_2048 = toPublicPem(KEY_PAIR_OTHER_2048.getPublic());
