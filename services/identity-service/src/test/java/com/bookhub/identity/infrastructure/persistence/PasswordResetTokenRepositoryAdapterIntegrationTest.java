...
class PasswordResetTokenRepositoryAdapterIntegrationTest extends PostgreSqlIntegrationTest {
    ...
    void shouldConsumeTokenHashAtomically() {
        ...
        final var consumedUserId = passwordResetTokenRepository.consumeUserIdByTokenHash(
                "token-consume-hash",
                Instant.parse("2026-04-12T20:00:00Z"));
        final var consumedAgain = passwordResetTokenRepository.consumeUserIdByTokenHash(
                "token-consume-hash",
                Instant.parse("2026-04-12T20:00:01Z"));
